...
The mvdXML (Model View Definition) format is a buildingSMART standard for defining validation rules over IFC models. IDMxPPM exports Exchange Requirements as mvdXML 1.1.
...
>
> Synthetic export is suitable for simple property-existence checks on regular psets. For complex structural validation rules, author the mvdXML directly and import it into IDMxPPM.
